      ...
      <CardContent className="flex flex-col">
        ...
        <div className="mt-15 flex w-full flex-col items-center justify-center gap-4">
          <div className="flex items-center justify-center px-4">
            ...
            <div className="mx-6 flex h-16 w-16 items-center justify-center rounded-full bg-orange-100">
              <p className="text-3xl-bold text-orange-500">2</p>
            </div>

            <div className="h-1 w-80 bg-green-600"></div>

            <div className="ml-6 flex h-16 w-16 items-center justify-center rounded-full bg-orange-100">
              <p className="text-3xl-bold text-orange-500">3</p>
            </div>
          </div>
          <div className="flex items-start justify-center gap-48">
            ...
            <div className="rounded-2xl p-4">
              <p className="text-lg-bold text-green-200">
